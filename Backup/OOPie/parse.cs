...
namespace OOPieCore
{
	...
	public partial class Parse
	{
        ...
        /// <summary> RuleNameFromFilePath
        ///   Return a rule as a string using the file Name.
        ///   eg. namespace_body_00.cs -> namespace_body
        /// </summary>
        protected virtual string RuleNameFromFilePath(string file_name)
        {
            string fnne = Path.GetFileNameWithoutExtension(file_name);
			string file_name_no_extension = string.Empty;
